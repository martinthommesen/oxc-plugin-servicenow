...
| 7 | `530f920`, `4af28f2`, `c98004d`, `e8c78f7`, `751d28b`, `d0e0b62` | artifact-only OIDC workflow, retries, governance declaration, live governance capture, repository-default action pins, dispatchable matrix, and cross-runtime JSON release fix |
