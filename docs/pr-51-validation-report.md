...
- `npm run bench` — pass; recommended small-to-large scale is approximately 2.16x. RSS is unavailable on this host; `benchmark.mjs --write` deliberately refuses to write a zero-RSS baseline.
