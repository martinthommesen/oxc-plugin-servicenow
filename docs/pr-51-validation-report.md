...
- `npm run bench` — pass; recommended small-to-large scale is approximately 1.9x in the final run. RSS is unavailable on this host; `benchmark.mjs --write` deliberately refuses to write a zero-RSS baseline.
