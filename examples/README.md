...
Each folder is a small runnable profile. Copy the folder, install this package, and run the commands in that folder's README.
...
The root `examples/.oxlintrc.json` is generated from recommended placements. Project files add the settings that profile needs.
